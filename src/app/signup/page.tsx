...
export default function SignUp() {
    ...
    return (
        <div className="bg-white flex-grow flex justify-center items-center">
            <form action={formAction} className="grid grid-cols-2 space-y-2.5">
                ...
                <Link href="/login" className="text-center text-sm !mt-4 self-center text-blue-600 col-span-2 sm:col-span-1">
